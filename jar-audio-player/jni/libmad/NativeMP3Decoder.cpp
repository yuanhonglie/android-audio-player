...
JNIEXPORT jint JNICALL Java_com_yhl_jni_Libmad_openFile(JNIEnv *env, jobject obj, jstring file)
{
...
JNIEXPORT jint JNICALL Java_com_yhl_jni_Libmad_readSamplesInFloatBuffer(JNIEnv *env, jobject obj, jint handle, jobject buffer, jint size)
{
...
JNIEXPORT void JNICALL Java_com_yhl_jni_Libmad_closeFile(JNIEnv *env, jobject obj, jint handle)
{
	if( handles[handle] != 0 )
	{
