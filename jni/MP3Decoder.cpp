...
JNIEXPORT jint JNICALL Java_com_yhl_jni_Mp3Decoder_readSamplesInFloatBuffer(JNIEnv *env, jobject obj, jint handle, jobject buffer, jint size)
{
...
JNIEXPORT jint JNICALL Java_com_yhl_jni_Mp3Decoder_readSamplesInShortBuffer(JNIEnv *env, jobject obj, jint handle, jshortArray buffer, jint size)
{
	MP3FileHandle* mp3 = handles[handle];
